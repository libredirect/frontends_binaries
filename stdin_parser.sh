...
tar -czvf stdin_parser_linux_x86_64.tar.gz stdin_parser/stdin_parser_linux_x86_64 stdin_parser/org.libredirect.stdin_parser.json
zip       stdin_parser_windows_x86_64.zip  stdin_parser/stdin_parser_windows_x86_64.exe stdin_parser/org.libredirect.stdin_parser.json
